...
from .sequences import XPathSequence, SingletonSequence, EmptySequence, \
...
__all__ = ['AbstractBinary', 'AbstractDateTime', 'ListType', 'AbstractQName',
           ...
           'XPathSequence', 'SingletonSequence', 'EmptySequence', 'empty_sequence',
           'to_sequence', 'iter_sequence']
